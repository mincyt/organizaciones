...
privileged aspect NombreDeOrganizacionController_Roo_Controller {
    ...
    @Autowired
    OrganizacionService NombreDeOrganizacionController.organizacionService;
    
    @Autowired
    IdiomaService NombreDeOrganizacionController.idiomaService;
    
    @Autowired
    EstadoService NombreDeOrganizacionController.estadoService;
    
    @Autowired
    NombreDeOrganizacionService NombreDeOrganizacionController.nombreDeOrganizacionService;
    ...
    public String NombreDeOrganizacionController.create(@Valid NombreDeOrganizacion nombreDeOrganizacion, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            ...
            return "nombresdeorganizacion/create";
        }
        uiModel.asMap().clear();
        nombreDeOrganizacionService.saveNombreDeOrganizacion(nombreDeOrganizacion);
        return "redirect:/nombresdeorganizacion/" + encodeUrlPathSegment(nombreDeOrganizacion.getNombredeorganizacionid().toString(), httpServletRequest);
    }
    ...
    public String NombreDeOrganizacionController.createForm(Model uiModel) {
        ...
        if (organizacionService.countAllOrganizaciones() == 0) {
            dependencies.add(new String[] { "organizacion", "organizaciones" });
        }
        if (idiomaService.countAllIdiomas() == 0) {
    ...
    public String NombreDeOrganizacionController.show(@PathVariable("nombredeorganizacionid") Long nombredeorganizacionid, Model uiModel) {
        uiModel.addAttribute("nombredeorganizacion", nombreDeOrganizacionService.findNombreDeOrganizacion(nombredeorganizacionid));
        uiModel.addAttribute("itemId", nombredeorganizacionid);
        return "nombresdeorganizacion/show";
    }
    ...
    public String NombreDeOrganizacionController.list(@RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, @RequestParam(value = "sortFieldName", required = false) String sortFieldName, @RequestParam(value = "sortOrder", required = false) String sortOrder, Model uiModel) {
        if (page != null || size != null) {
            ...
            uiModel.addAttribute("nombresdeorganizacion", nombreDeOrganizacionService.findNombreDeOrganizacionEntries(firstResult, sizeNo));
            float nrOfPages = (float) nombreDeOrganizacionService.countAllNombresDeOrganizacion() / sizeNo;
            uiModel.addAttribute("maxPages", (int) ((nrOfPages > (int) nrOfPages || nrOfPages == 0.0) ? nrOfPages + 1 : nrOfPages));
        } else {
            uiModel.addAttribute("nombresdeorganizacion", nombreDeOrganizacionService.findAllNombresDeOrganizacion());
        }
        return "nombresdeorganizacion/list";
    }
    ...
    public String NombreDeOrganizacionController.update(@Valid NombreDeOrganizacion nombreDeOrganizacion, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            populateEditForm(uiModel, nombreDeOrganizacion);
            return "nombresdeorganizacion/update";
        }
        uiModel.asMap().clear();
        nombreDeOrganizacionService.updateNombreDeOrganizacion(nombreDeOrganizacion);
        return "redirect:/nombresdeorganizacion/" + encodeUrlPathSegment(nombreDeOrganizacion.getNombredeorganizacionid().toString(), httpServletRequest);
    }
    ...
    public String NombreDeOrganizacionController.updateForm(@PathVariable("nombredeorganizacionid") Long nombredeorganizacionid, Model uiModel) {
        populateEditForm(uiModel, nombreDeOrganizacionService.findNombreDeOrganizacion(nombredeorganizacionid));
        return "nombresdeorganizacion/update";
    }
    ...
    public String NombreDeOrganizacionController.delete(@PathVariable("nombredeorganizacionid") Long nombredeorganizacionid, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
        NombreDeOrganizacion nombreDeOrganizacion = nombreDeOrganizacionService.findNombreDeOrganizacion(nombredeorganizacionid);
        nombreDeOrganizacionService.deleteNombreDeOrganizacion(nombreDeOrganizacion);
        uiModel.asMap().clear();
        uiModel.addAttribute("page", (page == null) ? "1" : page.toString());
        uiModel.addAttribute("size", (size == null) ? "10" : size.toString());
        return "redirect:/nombresdeorganizacion";
    }
